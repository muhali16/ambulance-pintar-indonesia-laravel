...
return [
     ...
     */
    'favicon' => env('APP_URL') . '/assets/images/resources/single-logo.webp',
    ...
    'title' => [
         ...
         */
        'suffix' => ' - Ambulance Pintar Indonesia',
         ...
         */
        'homepage_title' => "Ambulance Pintar Indonesia",
    ],
    ...
    'description' => [
         ...
         */
        'fallback' => 'PT Ambulance Pintar Indonesia adalah perusahaan yang bergerak di bidang spesialis ambulance, ambulance care, modifikasi, 4x4 system, rental, equipment dan donation.',
    ],
    ...
    'image' => [
         ...
         */
        'fallback' =>env('APP_URL') . '/assets/images/resources/single-logo.webp',
    ],
