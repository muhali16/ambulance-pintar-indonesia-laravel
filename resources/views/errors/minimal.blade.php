            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="error-content text-center">
                        ...
                        <div class="text">
                            <p>Halaman ini tidak tersedia atau sudah dipindahkan. <br>Periksa kembali apakah halaman yang anda maksud sudah tepat.</p>
                        </div>
                        <div class="btns-box wow slideInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <a class="btn-one" href="{{route('web.index')}}">
                                <span class="txt">Kembali ke Beranda<i class="icon-refresh arrow"></i></span>
                            </a>
                        </div>
